...
public class Pistol : MonoBehaviour
{
	...
	[SerializeField] private int bulletsPerMag = 10;
	[SerializeField] private int bulletsLeft = 40;
	[HideInInspector] public int BulletsLeft => bulletsLeft;
	private int startBullets = 40;
	[SerializeField] private int loadedBullets;
	[HideInInspector] public int LoadedBullets => loadedBullets;
	...
	void OnAmmoInsertion()
	{
		...
		//KK: loads only as long there is enought ammo left
		do
		{
			bulletsLeft--;
			loadedBullets++;
		} while (bulletsLeft > 0 && loadedBullets < bulletsPerMag);

...
public class Sniper : MonoBehaviour
{
	...
	[SerializeField] private int bulletsPerMag = 2;
	[SerializeField] private int bulletsLeft = 10;
	[SerializeField] private int startBullets = 10;
	[SerializeField] private int loadedBullets;
	[SerializeField] private int pellets = 1;
	[SerializeField] private float spread;
	[SerializeField] private float bulletEjectingSpeed = 7.5f;
	...
	void OnAmmoInsertion()
	{
		...
		bulletsLeft--;
		loadedBullets++;
		Debug.Log("loaded<bullets: " + loadedBullets);
		if(hasLastFire)
		{
			animator.SetBool("IsEmpty", false);	
		}
